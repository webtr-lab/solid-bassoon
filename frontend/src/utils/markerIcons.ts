 ...
 * @param color - CSS color (e.g., '#3b82f6')
 ...
 * @returns Leaflet icon
 */
export const createSavedLocationIcon = (): L.DivIcon => {
  return L.divIcon({
    className: 'custom-div-icon',
 ...
 * @returns Leaflet icon
 */
export const createPOIIcon = (): L.DivIcon => {
  return L.divIcon({
    className: 'custom-div-icon',
 ...
 */
export const vehicleColors: string[] = ['#3b82f6', '#ef4444', '#10b981', '#f59e0b', '#8b5cf6'];
