 ...
 * Displays vehicle statistics and provides data export functionality
 */
...
function VehicleStats({ vehicleId, historyHours }: VehicleStatsProps): JSX.Element | null {
  ...
  const fetchStats = async () => {
    try {
      const data = await apiFetch<StatsData>(`/api/vehicles/${vehicleId}/stats?hours=${historyHours}`);
      setStats(data);
    } catch (error) {
